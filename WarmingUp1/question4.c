...
void printBoard() {
   ...
   for (int i = 0; i < SIZE; i++) {
       ...
       for (int j = 0; j < SIZE; j++) {
        if(display[i][j] == 'A')
        {
           printf("\033[31m%c \033[0m", display[i][j]); 
        }
        ...
        {
            printf("\033[34m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'D')
        {
            printf("\033[35m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'E')
        {
            printf("\033[32m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'F')
        {
            printf("\033[36m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'G')
        {
            printf("\033[30m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'H')
        {
            printf("\033[37m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'I')
        {
            printf("\033[41m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'J')
        {
            printf("\033[42m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'K')
        {
            printf("\033[43m%c \033[0m", display[i][j]); 
        }
        else if(display[i][j] == 'L')
        {
            printf("\033[44m%c \033[0m", display[i][j]); 
        }
        else
        {
